...
![ 刷步数](https://github.com/TonyJiangWJ/autostep/actions/workflows/run.yml/badge.svg)
[![GitHub forks](https://img.shields.io/github/forks/TonyJiangWJ/autostep?style=flat-square)](https://github.com/TonyJiangWJ/autostep/forks)
[![GitHub stars](https://img.shields.io/github/stars/TonyJiangWJ/autostep?style=flat-square)](https://github.com/TonyJiangWJ/autostep/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/TonyJiangWJ/autostep?style=flat-square)](https://github.com/TonyJiangWJ/autostep/issues)
...
### 如果觉得好用，请给一个免费的[star](https://github.com/TonyJiangWJ/autostep/)吧
...
- `Repository access` 选择 `Only select repositories` 勾选自己fork后的仓库，下拉可搜索：输入 autostep 进行检索
...
-
快捷跳转地址 [https://github.com/${你的github用户名}/autostep/settings/secrets/actions](../../settings/secrets/actions)
...
-
快捷跳转地址 [https://github.com/${你的github用户名}/autostep/settings/variables/actions](../../settings/variables/actions)
...
- 前往Actions,左侧选择 `刷步数`
  ，快捷链接：[https://github.com/${你的github用户名}/autostep/actions/workflows/run.yml](../../actions/workflows/run.yml)
...
本项目基于 `https://github.com/xunichanghuan/autostep(已被ban)`
和 [https://github.com/huangshihai/autostep](https://github.com/huangshihai/autostep) 项目修改，特此感谢
...
6. 请各位在使用时Fork[当前仓库](https://github.com/TonyJiangWJ/autostep/)，防止出现不必要的bug.
